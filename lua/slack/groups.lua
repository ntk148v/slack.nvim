...
function M.create_groups(colors)
	...
	return {
		...
		Pmenu = { bg = colors.grey_dark, fg = colors.fg_light },
		PmenuSel = { bg = colors.cyan, fg = colors.bg_lighter, bold = true },
		PmenuSbar = { bg = colors.bg_lighter },
		PmenuThumb = { bg = colors.fg },
		Search = { bg = colors.hollow },
		...
		Visual = { bg = colors.hollow_lighter },
		VisualNOS = { bg = colors.hollow_lighter },
